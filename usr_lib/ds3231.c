...
int ds3231_enable_am_pm_mode(ds3231_t * rtc, bool enable) {
    uint8_t temp = 0;
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_HOURS_REG, 1, &temp))
        return -1;
    if(enable) {
        temp |= (0x01 << 6);
        rtc->am_pm_mode = true;
    ...
    if(i2c_write_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_HOURS_REG, 1, &temp))
        return -1;
    return 0;
}
...
int ds3231_configure_time(ds3231_t * rtc, ds3231_data_t * data) {
    ...
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_SECONDS_REG, 7, temp)) 
        return -1;
    ...
    if(i2c_write_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_SECONDS_REG, 7, temp)) 
        return -1;
    return 0;
}
...
int ds3231_read_current_time(ds3231_t * rtc, ds3231_data_t * data) {
    uint8_t raw_data[7];
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_SECONDS_REG, 7, raw_data)) 
        return -1;
...
int ds3231_set_alarm_1(ds3231_t * rtc, ds3231_alarm_1_t * alarm_time, enum ALARM_1_MASKS mask) {
    ...
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_SECONDS_ALARM_1_REG, 4, temp))
        return -1;
    ...
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &alarm_enable))
        return -1;    
    alarm_enable |= (0x01);
    if(i2c_write_reg_ds3231rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &alarm_enable))
        return -1;

    if(i2c_write_reg_ds3231(rtc->ds3231_addr, DS3231_SECONDS_ALARM_1_REG, 4, temp))
        return -1;
    return 0;
}
...
int ds3231_set_alarm_2(ds3231_t * rtc, ds3231_alarm_2_t * alarm_time, enum ALARM_2_MASKS mask) {
    ...
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_MINUTES_ALARM_2_REG, 3, temp))
        return -1;
    ...
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &alarm_enable))
        return -1;    
    alarm_enable |= (0x02);
    if(i2c_write_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &alarm_enable))
        return -1;

    if(i2c_write_reg_ds3231(rtc->ds3231_addr, DS3231_MINUTES_ALARM_2_REG, 3, temp))
        return -1;
    return 0;
}
...
int ds3231_enable_alarm_interrupt(ds3231_t * rtc, bool enable) {
    ...
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &interrupt_enable))
        return -1;    
    if(enable)
        interrupt_enable |= (0x01 << 2);
    else 
        interrupt_enable &= ~(0x01 << 2);
    if(i2c_write_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &interrupt_enable))
        return -1;
    return 0;
} 
...
int ds3231_enable_32khz_square_wave(ds3231_t * rtc, bool enable) {
    uint8_t status = 0;
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_STATUS_REG, 1, &status))
        return -1;
    if(enable) 
        status |= (0x01 << 3);
    else 
        status &= ~(0x01 << 3);
    if(i2c_write_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_STATUS_REG, 1, &status))
        return -1;    
    return 0;    
}
...
int ds3231_enable_oscillator(ds3231_t * rtc, bool enable) {
    ...
    if(i2c_read_reg_ds3231(rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &enable_byte))
        return -1;    
    if(!enable)
        enable_byte |= (0x01 << 7);
    else 
        enable_byte &= ~(0x01 << 7);
    if(i2c_write_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &enable_byte))
        return -1; 
    return 0;   
}
...
int ds3231_enable_battery_backed_square_wave(ds3231_t * rtc, bool enable) {
    uint8_t enable_byte = 0;
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &enable_byte))
        return -1;    
    if(enable) {
        enable_byte |= (0x01 << 6);
        enable_byte &= ~(0x01 << 2);
...
int ds3231_force_convert_temperature(ds3231_t * rtc) {
    ...
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_CONTROL_STATUS_REG, 1, &status)) 
        return -1;
    ...
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &status)) 
        return -1;    
    status |= (0x01 <<  5);
    if(i2c_write_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_CONTROL_REG, 1, &status)) 
        return -1;
    return 0;
}
...
int ds3231_read_temperature(ds3231_t * rtc, float * temperature) {
    uint8_t temp[2] = {0, 0};
    if(i2c_read_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_TEMPERATURE_MSB_REG, 2, temp))
        return -1;
...
int ds3231_set_aging_offset(ds3231_t * rtc, int8_t offset) {
    ...
    if(i2c_write_reg_ds3231(rtc->i2c, rtc->ds3231_addr, DS3231_AGING_OFFSET_REG, 1, &aging_offset))
        return -1;    
    return 0;
}
